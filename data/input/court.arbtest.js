...
const { arbtest: governor } = require('./governor')
...
const HNY = {
  symbol: 'HNY',
  decimals: 18,
  address: requireOutput('minime.arbtest', getAddressIfDefined('HNYT'))
}

const DAI = {
  symbol: 'DAI',
  decimals: 18,
  address: requireOutput('minime.arbtest', getAddressIfDefined('DAI'))
}
...
module.exports = {
  ...
  brightIdRegister: {
    address: '0x8fd6fb6270cc81fca2c583c58f2af707686886e8'      // The BrightIdRegister address, requires deploying first part of DAO
  },
  feesUpdater: {
    priceOracle: '0x0eb000e89004b345cf1Dd92E7a3f408beEfe3740', // Using HNY and DAI, with HNY as incentive token
