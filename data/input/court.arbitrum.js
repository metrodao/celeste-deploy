...
const { arbitrum: governor } = require('./governor')
...
const HNY = {
  symbol: 'HNY',
  decimals: 18,
  address: requireOutput('minime.arbitrum', getAddressIfDefined('HNY'))
}

const DAI = {
  symbol: 'DAI',
  decimals: 18,
  address: requireOutput('minime.arbitrum', getAddressIfDefined('DAI'))
}
...
module.exports = {
  ...
  brightIdRegister: {
    address: ""      // The BrightIdRegister address, copy in after deploying first part of DAO
  },
  feesUpdater: {
    priceOracle: "", // Using HNY and DAI, with HNY as incentive token
